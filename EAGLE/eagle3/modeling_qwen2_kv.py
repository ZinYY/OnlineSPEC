...
class Qwen2RotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        ...
        # Force float32 (see huggingface/transformers/pull/29285)
...
class Qwen2FlashAttention2(Qwen2Attention):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # flash_attn<2.1 generates top-left aligned causal mask, while what is needed here is bottom-right alignement, that was made default for flash_attn>=2.1. This attribute is used to handle this difference. Reference: Dao-AILab/flash-attention/releases/tag/v2.1.0.
...
class Qwen2SdpaAttention(Qwen2Attention):
    ...
    def forward(
        ...
        # Reference: pytorch/pytorch/issues/112577.
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def _update_causal_mask(
        ...
        if (
            ...
            # Details: pytorch/pytorch/issues/110213
