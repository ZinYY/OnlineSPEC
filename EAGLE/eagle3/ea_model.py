...
class EaModel(nn.Module):
    ...
    def __init__(
        ...
        if self.tokenizer.pad_token is None:
            ...
            print(f"⚠️  Warning: pad_token was None, setting to eos_token ('{self.tokenizer.eos_token}')")
    ...
    def eagenerate(
        ...
        for idx in range(max_length):
            ...
            accept_lengths_tree.append(int(accept_length + 1))
            # print(accept_length)
        ...
        if not log:
            ...
            return input_ids, new_token, idx, accept_lengths_tree
