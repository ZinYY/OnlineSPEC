...
from evaluation import get_model_answers, ea_forward
...
def run_pipeline(
    ...
    print("=== EAGLE pipeline starts execution ===")
    ...
    for i, chunk_file in enumerate(chunk_files):
        ...
        speeds_list, accept_lengths_list, evaluate_time = evaluate(chunk_file, base_model_path, ea_temp_dir)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='EAGLE pipeline')
