# Adapted from: lm-sys/FastChat/blob/main/fastchat/serve/cli.py
"""
Chat with a model with command line interface.

Usage:
python3 -m hydra.inference.cli --model <model_name_or_path>
Other commands:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-hydra-heads", type=int, default=4, help="Number of hydra heads")
    parser.add_argument("--grounded-heads", action="store_true", help="Ground heads on sampled toks.")
    parser.add_argument(
